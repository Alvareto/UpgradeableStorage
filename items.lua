return {
    ...
    PlaceObj('ModItemBuildingTemplate', {
        ...
        'pin_rollover_hint', T{253430560110, --[[ModItemBuildingTemplate WasteRockDumpBig pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"}, 
        'pin_rollover_hint_xbox', T{978590171635, --[[ModItemBuildingTemplate WasteRockDumpBig pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"}, 
        'build_points', 0, 
        'instant_build', true, 
        'dome_forbidden', true, 
        'hide_from_build_menu', true, 
        'upgrade1_id', "WasteRockDumpSite_ExtraStorage", 
        'upgrade1_display_name', T{503751464115, --[[ModItemBuildingTemplate WasteRockDumpBig upgrade1_display_name]] "Extra Storage"}, 
        'upgrade1_description', T{932023317152, --[[ModItemBuildingTemplate WasteRockDumpBig upgrade1_description]] "+<upgrade1_add_value_1> Storage Space."}, 
        'upgrade1_icon', "UI/Icons/Upgrades/service_bots_01.tga", 
        'upgrade1_upgrade_cost_Concrete', 10000, 
        'upgrade1_upgrade_time', 60000, 
        ...
        'display_name', T{759038059070, --[[ModItemBuildingTemplate WasteRockDumpBig display_name]] "Upgradeable Dump Site"}, 
        'display_name_pl', T{324736921511, --[[ModItemBuildingTemplate WasteRockDumpBig display_name_pl]] "Upgradeable Dumping Sites"}, 
        'description', T{563281929874, --[[ModItemBuildingTemplate WasteRockDumpBig description]] "Stores <wasterock(max_amount_WasteRock)>. Waste Rock is produced as side product of different mining activities."}, 
        'build_category', "Storages", 
