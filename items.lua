return {
    ...
    PlaceObj('ModItemBuildingTemplate', {
        'name', "StorageUniversalSmall", 
        'template_class', "UniversalStorageDepot", 
        'pin_rollover_hint', T{772949791068, --[[ModItemBuildingTemplate StorageUniversalSmall pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"}, 
        'pin_rollover_hint_xbox', T{884549026443, --[[ModItemBuildingTemplate StorageUniversalSmall pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"}, 
        'build_points', 0, 
        'instant_build', true, 
        'dome_forbidden', true, 
        'upgrade1_id', "StorageUniversalSmall_ExtraStorage", 
        'upgrade1_display_name', T{964726289799, --[[ModItemBuildingTemplate StorageUniversalSmall upgrade1_display_name]] "Extra Storage"}, 
        'upgrade1_description', T{834540050795, --[[ModItemBuildingTemplate StorageUniversalSmall upgrade1_description]] "+<upgrade1_add_value_1> Storage Space."}, 
        'upgrade1_icon', "UI/Icons/Upgrades/service_bots_01.tga", 
        'upgrade1_upgrade_cost_Concrete', 10000, 
        'upgrade1_upgrade_time', 60000, 
        'upgrade1_mod_label_1', "UniversalStorageDepot", 
        'upgrade1_mod_prop_id_1', "max_storage_per_resource", 
        'upgrade1_add_value_1', 30, 
        'display_name', T{793588514451, --[[ModItemBuildingTemplate StorageUniversalSmall display_name]] "Upgradeable Universal Depot"}, 
        'display_name_pl', T{217851185374, --[[ModItemBuildingTemplate StorageUniversalSmall display_name_pl]] "Upgradeable Universal Storages"}, 
        'description', T{909738725237, --[[ModItemBuildingTemplate StorageUniversalSmall description]] "Stores <max_storage_per_resource> units of each transportable resource. Excess resources will be delivered automatically to other depots within Drone range."}, 
        'build_category', "Storages", 
        'display_icon', "UI/Icons/Buildings/storage_depot.tga", 
        'entity', "StorageDepot", 
